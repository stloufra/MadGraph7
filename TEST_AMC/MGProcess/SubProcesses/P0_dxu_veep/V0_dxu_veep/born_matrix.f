...
C     
C     Provides the same SMATRIX interface as matrix_standalone_v4.inc,
C     summing over the selected split-order configurations.
C     
C     
C     CONSTANTS
C     
...
C     
C     Process: d~ u > ve e+ [ all = QCD QED ] QCD^2<=2 QED^2<=4
C     Process: s~ c > ve e+ [ all = QCD QED ] QCD^2<=2 QED^2<=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV2_3(W(2),W(1),GC_11,MDL_MW,MDL_WW,W(5))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(4),W(3),W(5),GC_11,AMP(1))
