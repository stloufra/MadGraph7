...
C     
C     
C     Process: g u > ve e+ d [ all = QCD QED ] QCD^2<=2 QED^2<=4
C     Process: g c > ve e+ s [ all = QCD QED ] QCD^2<=2 QED^2<=4
C     
C     
C     CONSTANTS
C     
...
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(6),W(5),W(7),GC_11,AMP(1))
      CALL FFV1_1(W(5),W(1),GC_5,ZERO,ZERO,W(6))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(2),W(6),W(7),GC_11,AMP(2))
