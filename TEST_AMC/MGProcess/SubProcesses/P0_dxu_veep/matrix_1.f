...
C     
C     
C     Process: d~ u > ve e+ g [ all = QCD QED ] QCD^2<=2 QED^2<=4
C     Process: s~ c > ve e+ g [ all = QCD QED ] QCD^2<=2 QED^2<=4
C     
C     
C     CONSTANTS
C     
...
C     ----------
      ...
      CALL FFV1_1(W(1),W(5),GC_5,ZERO,ZERO,W(6))
      CALL FFV2_3(W(4),W(3),GC_11,MDL_MW,MDL_WW,W(7))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(2),W(6),W(7),GC_11,AMP(1))
      CALL FFV1_2(W(2),W(5),GC_5,ZERO,ZERO,W(6))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(6),W(1),W(7),GC_11,AMP(2))
