...
C      if true.
      ...
      CALL MP_FFV2_3(W(1),W(2),GC_11,MDL_MW,MDL_WW,W(5))
C     Amplitude(s) for born diagram with ID 1
      CALL MP_FFV2_0(W(4),W(3),W(5),GC_11,AMP(1))
      CALL MP_FFV2_3(W(4),W(3),GC_11,MDL_MW,MDL_WW,W(6))
C     Counter-term amplitude(s) for loop diagram number 2
      CALL MP_FFV2_0(W(1),W(2),W(6),R2_BXTW,AMPL(1,1))
