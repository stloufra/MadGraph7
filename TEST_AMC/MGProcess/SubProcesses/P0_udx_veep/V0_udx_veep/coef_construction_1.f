...
C     Coefficient construction for loop diagram with ID 2
      CALL FFV1L2P0_3(PL(0,0),W(1),GC_5,ZERO,ZERO,PL(0,1),COEFS)
      CALL UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,1))
      CALL FFV1L3_1(PL(0,1),W(2),GC_5,ZERO,ZERO,PL(0,2),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,1),4,COEFS,4,4,WL(1,0,1,2))
      CALL FFV2L2_1(PL(0,2),W(6),GC_11,ZERO,ZERO,PL(0,3),COEFS)
