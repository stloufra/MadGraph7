...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV1_1(W(5),W(2),GC_5,ZERO,ZERO,W(6))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1),W(6),W(7),GC_5,AMP(5))
