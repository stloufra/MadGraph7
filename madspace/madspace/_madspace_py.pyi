...
class AdamOptimizer:
    class LRSchedule:
        ...
        Members:
          ...
          cosine
        """
        __members__: typing.ClassVar[dict[str, AdamOptimizer.LRSchedule]]  # value = {'none': <LRSchedule.none: 0>, 'cosine': <LRSchedule.cosine: 1>}
    ...
    cosine: typing.ClassVar[AdamOptimizer.LRSchedule]  # value = <LRSchedule.cosine: 1>
    none: typing.ClassVar[AdamOptimizer.LRSchedule]  # value = <LRSchedule.none: 0>
    def __init__(self, function: Function, context: Context, learning_rate: typing.SupportsFloat, schedule: AdamOptimizer.LRSchedule = AdamOptimizer.LRSchedule.LRSchedule.none, step_count: typing.SupportsInt = 0, beta1: typing.SupportsFloat = 0.9, beta2: typing.SupportsFloat = 0.999, eps: typing.SupportsFloat = 1e-08) -> None:
        ...
...
class ChannelEventGenerator:
    ...
    @staticmethod
    def load(channel_file: str, contexts: collections.abc.Sequence[Context], event_file: str, weight_file: str, config: GeneratorConfig) -> ChannelEventGenerator:
        ...
    def __init__(self, contexts: collections.abc.Sequence[Context], integrand: Integrand, event_file: str, weight_file: str, config: GeneratorConfig, subprocess_index: typing.SupportsInt, name: str, histograms: madspace._madspace_py.ObservableHistograms | None) -> None:
        ...
...
class ChannelWeightNetwork(FunctionGenerator):
    def __init__(self, channel_count: typing.SupportsInt, particle_count: typing.SupportsInt, hidden_dim: typing.SupportsInt = 32, layers: typing.SupportsInt = 3, activation: MLP.Activation = MLP.Activation.Activation.leaky_relu, prefix: str = '', include_preprocessing: bool = True) -> None:
        ...
...
class ColorOrderedMapping(Mapping):
    def __init__(self, colour_order: collections.abc.Sequence[typing.SupportsInt], t_invariant_power: typing.SupportsFloat = 0.0, s_invariant_power: typing.SupportsFloat = 0.0) -> None:
        ...
...
class Context:
    ...
    def __init__(self, thread_count: typing.SupportsInt = -1) -> None:
        ...
    @typing.overload
    def __init__(self, device: Device, thread_count: typing.SupportsInt = -1) -> None:
        ...
    ...
    def save_globals(self, dir: str) -> None:
        ...
class CutItem:
    def __init__(self, observable: Observable, min: typing.SupportsFloat = ..., max: typing.SupportsFloat = ..., mode: Cuts.CutMode = Cuts.CutMode.CutMode.all) -> None:
        ...
    @property
    def max(self) -> float:
        ...
...
class Cuts(FunctionGenerator):
    class CutMode:
        ...
        Members:
          ...
          all
        """
        __members__: typing.ClassVar[dict[str, Cuts.CutMode]]  # value = {'any': <CutMode.any: 0>, 'all': <CutMode.all: 1>}
...
class DifferentialCrossSection(FunctionGenerator):
    def __init__(self, matrix_element: MatrixElement, cm_energy: typing.SupportsFloat, running_coupling: RunningCoupling, energy_scale: EnergyScale, pid_options: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsInt]] = [], has_pdf1: bool = False, has_pdf2: bool = False, pdf_grid1: madspace._madspace_py.PdfGrid | None = None, pdf_grid2: madspace._madspace_py.PdfGrid | None = None, has_mirror: bool = False, input_momentum_fraction: bool = True) -> None:
        ...
...
class DiscreteHistogram(FunctionGenerator):
    def __init__(self, option_counts: collections.abc.Sequence[typing.SupportsInt]) -> None:
        ...
class DiscreteOptimizer:
    def __init__(self, contexts: collections.abc.Sequence[Context], prob_names: collections.abc.Sequence[str]) -> None:
        ...
    def add_data(self, values_and_counts: collections.abc.Sequence[typing.Any]) -> None:
        ...
...
class DoubleT(Mapping):
    def __init__(self, t1_invariant_power: typing.SupportsFloat = 0.0, t1_mass: typing.SupportsFloat = 0.0, t1_width: typing.SupportsFloat = 0.0, t2_invariant_power: typing.SupportsFloat = 0.0, t2_mass: typing.SupportsFloat = 0.0, t2_width: typing.SupportsFloat = 0.0) -> None:
        ...
...
class EventGenerator:
    default_config: typing.ClassVar[GeneratorConfig]  # value = <madspace._madspace_py.GeneratorConfig object>
    def __init__(self, contexts: collections.abc.Sequence[Context], channels: collections.abc.Sequence[ChannelEventGenerator], status_file: str = '', config: GeneratorConfig = ...) -> None:
        ...
    ...
    def combine_to_lhe(self, file_name: str, lhe_completer: LHECompleter) -> None:
        ...
    def combine_to_lhe_npy(self, file_name: str, lhe_completer: LHECompleter) -> None:
        ...
...
class FunctionBuilder:
    ...
    def add_int(self, in1: Value, in2: Value) -> Value:
        ...
    def apply_subchannel_weights(self, channel_weights_in: Value, subchannel_weights: Value, channel_indices: Value, subchannel_indices: Value) -> Value:
        ...
    ...
    def cat(self, args: collections.abc.Sequence[Value]) -> Value:
        ...
    def chili_forward(self, r: Value, e_cm: Value, m_out: Value, pt_min: Value, y_max: Value) -> typing.Annotated[list[Value], "FixedSize(2)"]:
        ...
    def chili_inverse(self, p_ext: Value, e_cm: Value, m_out: Value, pt_min: Value, y_max: Value) -> typing.Annotated[list[Value], "FixedSize(2)"]:
        ...
    ...
    def diff_cross_section(self, x1: Value, x2: Value, pdf1: Value, pdf2: Value, matrix_element: Value, e_cm2: Value) -> Value:
        ...
    def discrete_histogram(self, input: Value, weights: Value, option_count: Value) -> typing.Annotated[list[Value], "FixedSize(2)"]:
        ...
    def div(self, in1: Value, in2: Value) -> Value:
        ...
    def double_t_scattering(self, r_phi: Value, pa: Value, pb: Value, t1_abs: Value, t2_abs: Value, m1: Value) -> typing.Annotated[list[Value], "FixedSize(3)"]:
        ...
    def double_t_scattering_inverse(self, p1: Value, p2: Value, pa: Value, pb: Value) -> typing.Annotated[list[Value], "FixedSize(2)"]:
        ...
    ...
    def fast_rambo_massive_com(self, r: Value, e_cm: Value, masses: Value) -> typing.Annotated[list[Value], "FixedSize(2)"]:
        ...
    def fast_rambo_massive_inverse(self, p_out: Value, e_cm: Value, masses: Value) -> typing.Annotated[list[Value], "FixedSize(3)"]:
        ...
    ...
    def fast_rambo_massless_com(self, r: Value, e_cm: Value) -> typing.Annotated[list[Value], "FixedSize(2)"]:
        ...
    def fast_rambo_massless_inverse(self, p_out: Value, e_cm: Value) -> typing.Annotated[list[Value], "FixedSize(3)"]:
        ...
    ...
    def get_global(self, name: str, dtype: DataType, shape: collections.abc.Sequence[typing.SupportsInt]) -> Value:
        ...
    def histogram(self, input: Value, weights: Value, min: Value, max: Value, bin_count: Value) -> typing.Annotated[list[Value], "FixedSize(2)"]:
        ...
    ...
    def madnis_single_channel_variance(self, var: Value, abs_mean: Value) -> Value:
        ...
    def madnis_softclip(self, f: Value, q: Value, norm: Value, threshold: Value) -> Value:
        ...
    ...
    def mirror_momenta(self, p_ext: Value, mirror: Value) -> Value:
        ...
    def momenta_to_x1x2(self, p_ext: Value, e_cm: Value) -> typing.Annotated[list[Value], "FixedSize(2)"]:
        ...
    ...
    def obs_y_abs(self, p: Value) -> Value:
        ...
    def offset_indices(self, batch_sizes_offset: Value, batch_sizes_out: Value) -> Value:
        ...
    ...
    def rqs_inverse(self, input: Value, condition: Value) -> typing.Annotated[list[Value], "FixedSize(2)"]:
        ...
    def rqs_reshape(self, input: Value, bin_count: Value) -> typing.Annotated[list[Value], "FixedSize(3)"]:
        ...
    def s23_min_max(self, pa: Value, pb: Value, p3: Value, t1_abs: Value, m1: Value, m2: Value) -> typing.Annotated[list[Value], "FixedSize(2)"]:
        ...
    def s23_value_and_min_max(self, pa: Value, pb: Value, p3: Value, t1_abs: Value, p1: Value, p2: Value) -> typing.Annotated[list[Value], "FixedSize(3)"]:
        ...
    ...
    def sub(self, in1: Value, in2: Value) -> Value:
        ...
    def subchannel_weights(self, invariants: Value, masses: Value, widths: Value, indices: Value, on_shell: Value, group_sizes: Value) -> Value:
        ...
    def t1_inv_min_max_doublet(self, pa: Value, pb: Value, m1: Value, mir_min: Value) -> typing.Annotated[list[Value], "FixedSize(2)"]:
        ...
    def t1_inv_value_and_min_max_doublet(self, pa: Value, pb: Value, p1: Value, m1: Value, mir_min: Value) -> typing.Annotated[list[Value], "FixedSize(3)"]:
        ...
    def t2_inv_min_max_doublet(self, pa: Value, pb: Value, m1: Value, mir_min: Value, t1_abs: Value) -> typing.Annotated[list[Value], "FixedSize(2)"]:
        ...
    def t2_inv_value_and_min_max_doublet(self, pa: Value, pb: Value, p1: Value, m1: Value, mir_min: Value, t1_abs: Value) -> typing.Annotated[list[Value], "FixedSize(3)"]:
        ...
    def t_inv_min_max(self, pa: Value, pb: Value, m1: Value, m2: Value) -> typing.Annotated[list[Value], "FixedSize(2)"]:
        ...
    def t_inv_value_and_min_max(self, pa: Value, pb: Value, p1: Value, p2: Value) -> typing.Annotated[list[Value], "FixedSize(3)"]:
        ...
    def three_body_decay(self, r_e1: Value, r_e2: Value, r_phi: Value, r_cos_theta: Value, r_beta: Value, m0: Value, m1: Value, m2: Value, m3: Value, p0: Value) -> typing.Annotated[list[Value], "FixedSize(4)"]:
        ...
    def three_body_decay_com(self, r_e1: Value, r_e2: Value, r_phi: Value, r_cos_theta: Value, r_beta: Value, m0: Value, m1: Value, m2: Value, m3: Value) -> typing.Annotated[list[Value], "FixedSize(4)"]:
        ...
    def three_body_decay_com_inverse(self, p1: Value, p2: Value, p3: Value) -> typing.Annotated[list[Value], "FixedSize(10)"]:
        ...
    def three_body_decay_inverse(self, p1: Value, p2: Value, p3: Value) -> typing.Annotated[list[Value], "FixedSize(11)"]:
        ...
    def two_body_decay(self, r_phi: Value, r_cos_theta: Value, m0: Value, m1: Value, m2: Value, p0: Value) -> typing.Annotated[list[Value], "FixedSize(3)"]:
        ...
    def two_body_decay_com(self, r_phi: Value, r_cos_theta: Value, m0: Value, m1: Value, m2: Value) -> typing.Annotated[list[Value], "FixedSize(3)"]:
        ...
    def two_body_decay_com_inverse(self, p1: Value, p2: Value) -> typing.Annotated[list[Value], "FixedSize(6)"]:
        ...
    def two_body_decay_inverse(self, p1: Value, p2: Value) -> typing.Annotated[list[Value], "FixedSize(7)"]:
        ...
    def two_to_three_particle_scattering(self, phi_choice: Value, pa: Value, pb: Value, p3: Value, s23: Value, t1_abs: Value, m1: Value, m2: Value) -> typing.Annotated[list[Value], "FixedSize(3)"]:
        ...
    def two_to_three_particle_scattering_inverse(self, p1: Value, p2: Value, p3: Value, pa: Value, pb: Value, t1_abs: Value, s23: Value) -> typing.Annotated[list[Value], "FixedSize(4)"]:
        ...
    def two_to_two_particle_scattering(self, r_phi: Value, pa: Value, pb: Value, t_abs: Value, m1: Value, m2: Value) -> typing.Annotated[list[Value], "FixedSize(3)"]:
        ...
    def two_to_two_particle_scattering_com(self, r_phi: Value, pa: Value, pb: Value, t_abs: Value, m1: Value, m2: Value) -> typing.Annotated[list[Value], "FixedSize(3)"]:
        ...
    def two_to_two_particle_scattering_com_inverse(self, p1: Value, p2: Value, pa: Value, pb: Value) -> typing.Annotated[list[Value], "FixedSize(4)"]:
        ...
    def two_to_two_particle_scattering_inverse(self, p1: Value, p2: Value, pa: Value, pb: Value) -> typing.Annotated[list[Value], "FixedSize(4)"]:
        ...
    ...
    def vegas_forward(self, input: Value, grid: Value) -> typing.Annotated[list[Value], "FixedSize(2)"]:
        ...
    def vegas_histogram(self, input: Value, weights: Value, bin_count: Value) -> typing.Annotated[list[Value], "FixedSize(2)"]:
        ...
...
class FunctionGenerator:
    def __call__(self, *args, **kwargs):
        ...
    def __init__(self, name: str, arg_types: NamedTypes, return_types: NamedTypes) -> None:
        ...
    @typing.overload
    def build_function(self, builder: FunctionBuilder, args: collections.abc.Sequence[Value]) -> NamedValues:
        ...
    @typing.overload
    def build_function(self, builder: FunctionBuilder, args: NamedValues) -> NamedValues:
        ...
    def function(self) -> Function:
        ...
class FunctionRuntime:
    ...
    def call(self, arg0: collections.abc.Sequence[typing.Any]) -> list[Tensor]:
        ...
    def call_backward(self, arg0: collections.abc.Sequence[typing.Any], arg1: collections.abc.Sequence[typing.Any], arg2: collections.abc.Sequence[bool]) -> tuple[list[madspace._madspace_py.Tensor | None], list[tuple[str, madspace._madspace_py.Tensor | None]]]:
        ...
    def call_with_grad(self, arg0: collections.abc.Sequence[typing.Any], arg1: collections.abc.Sequence[bool]) -> tuple[list[Tensor], list[madspace._madspace_py.Tensor | None], list[bool]]:
        ...
...
class GeneratorStatus:
    ...
    def subprocess(self, arg0: typing.SupportsInt) -> None:
        ...
class HistItem:
    def __init__(self, observable: Observable, min: typing.SupportsFloat, max: typing.SupportsFloat, bin_count: typing.SupportsInt) -> None:
        ...
    @property
...
class Integrand(FunctionGenerator):
    ...
    matrix_element_inputs: typing.ClassVar[list]  # value = [<MatrixElementInput.momenta_in: 0>, <MatrixElementInput.alpha_s_in: 1>, <MatrixElementInput.flavor_in: 2>, <MatrixElementInput.random_color_in: 3>, <MatrixElementInput.random_helicity_in: 4>, <MatrixElementInput.random_diagram_in: 5>]
    matrix_element_outputs: typing.ClassVar[list]  # value = [<MatrixElementOutput.matrix_element_out: 0>, <MatrixElementOutput.diagram_amp2_out: 1>, <MatrixElementOutput.color_index_out: 2>, <MatrixElementOutput.helicity_index_out: 3>, <MatrixElementOutput.diagram_index_out: 4>]
    ...
    def __init__(self, mapping: PhaseSpaceMapping, diff_xs: DifferentialCrossSection, adaptive_map: None | madspace._madspace_py.VegasMapping | madspace._madspace_py.Flow = None, discrete_before: None | madspace._madspace_py.DiscreteSampler | madspace._madspace_py.DiscreteFlow = None, discrete_after: None | madspace._madspace_py.DiscreteSampler | madspace._madspace_py.DiscreteFlow = None, pdf_grid: madspace._madspace_py.PdfGrid | None = None, energy_scale: madspace._madspace_py.EnergyScale | None = None, prop_chan_weights: madspace._madspace_py.PropagatorChannelWeights | None = None, subchan_weights: madspace._madspace_py.SubchannelWeights | None = None, chan_weight_net: madspace._madspace_py.ChannelWeightNetwork | None = None, chan_weight_remap: collections.abc.Sequence[typing.SupportsInt] = [], remapped_chan_count: typing.SupportsInt = 0, flags: typing.SupportsInt = 0, channel_indices: collections.abc.Sequence[typing.SupportsInt] = [], active_flavors: collections.abc.Sequence[typing.SupportsInt] = [], flavor_remap: collections.abc.Sequence[typing.SupportsInt] = [], flavor_factors: collections.abc.Sequence[typing.SupportsFloat] = []) -> None:
        ...
    def adaptive_map(self) -> None | madspace._madspace_py.VegasMapping | madspace._madspace_py.Flow:
        ...
    def chan_weight_net(self) -> madspace._madspace_py.ChannelWeightNetwork | None:
        ...
    def diff_xs(self) -> DifferentialCrossSection:
        ...
    def discrete_after(self) -> None | madspace._madspace_py.DiscreteSampler | madspace._madspace_py.DiscreteFlow:
        ...
    def discrete_before(self) -> None | madspace._madspace_py.DiscreteSampler | madspace._madspace_py.DiscreteFlow:
        ...
    ...
    def particle_count(self) -> int:
        ...
    def prop_chan_weights(self) -> madspace._madspace_py.PropagatorChannelWeights | None:
        ...
    def random_dim(self) -> int:
        ...
...
class LHECompleter:
    ...
    def load(file: str) -> LHECompleter:
        ...
    def __init__(self, subproc_args: collections.abc.Sequence[SubprocArgs], bw_cutoff: typing.SupportsFloat) -> None:
        ...
    def save(self, file: str) -> None:
        ...
    @property
    def max_particle_count(self) -> int:
        ...
class LHEEvent:
    def __init__(self, process_id: typing.SupportsInt = 0, weight: typing.SupportsFloat = 0.0, scale: typing.SupportsFloat = 0.0, alpha_qed: typing.SupportsFloat = 0.0, alpha_qcd: typing.SupportsFloat = 0.0, particles: collections.abc.Sequence[LHEParticle] = []) -> None:
        ...
    @property
...
class LHEParticle:
    ...
    def __init__(self, pdg_id: typing.SupportsInt = 0, status_code: typing.SupportsInt = 0, mother1: typing.SupportsInt = 0, mother2: typing.SupportsInt = 0, color: typing.SupportsInt = 0, anti_color: typing.SupportsInt = 0, p_x: typing.SupportsFloat = 0.0, p_y: typing.SupportsFloat = 0.0, p_z: typing.SupportsFloat = 0.0, energy: typing.SupportsFloat = 0.0, mass: typing.SupportsFloat = 0.0, lifetime: typing.SupportsFloat = 0.0, spin: typing.SupportsFloat = 0.0) -> None:
        ...
    @property
...
class Logger:
    class LogLevel:
        ...
        Members:
          ...
          level_error
        """
        __members__: typing.ClassVar[dict[str, Logger.LogLevel]]  # value = {'level_debug': <LogLevel.level_debug: 0>, 'level_info': <LogLevel.level_info: 1>, 'level_warning': <LogLevel.level_warning: 2>, 'level_error': <LogLevel.level_error: 3>}
        ...
        level_warning: typing.ClassVar[Logger.LogLevel]  # value = <LogLevel.level_warning: 2>
        def __eq__(self, other: typing.Any) -> bool:
            ...
        def __getstate__(self) -> int:
            ...
    ...
    def log(level: Logger.LogLevel, message: str) -> None:
        ...
    @staticmethod
    def set_log_handler(func: collections.abc.Callable[[Logger.LogLevel, str], None]) -> None:
        ...
    @staticmethod
...
class MadnisLoss(FunctionGenerator):
    def __init__(self, functions: collections.abc.Sequence[FunctionGenerator], cwnet: madspace._madspace_py.ChannelWeightNetwork | None, softclip_threshold: typing.SupportsFloat = 0.0) -> None:
        ...
class MadnisTraining:
    def __init__(self, generator_context: Context, optimizer_context: Context, config: MadnisConfig, integrands: collections.abc.Sequence[Integrand], cwnet: madspace._madspace_py.ChannelWeightNetwork | None) -> None:
        ...
    ...
    def train_step(self, batch_index: typing.SupportsInt) -> None:
        ...
class Mapping:
    def __init__(self, name: str, input_types: NamedTypes, output_types: NamedTypes, condition_types: NamedTypes) -> None:
        ...
    @typing.overload
    def build_forward(self, builder: FunctionBuilder, inputs: collections.abc.Sequence[Value], conditions: collections.abc.Sequence[Value]) -> NamedValues:
        ...
    @typing.overload
    def build_forward(self, builder: FunctionBuilder, inputs: NamedValues, conditions: NamedValues) -> NamedValues:
        ...
    @typing.overload
    def build_inverse(self, builder: FunctionBuilder, inputs: collections.abc.Sequence[Value], conditions: collections.abc.Sequence[Value]) -> NamedValues:
        ...
    @typing.overload
    def build_inverse(self, builder: FunctionBuilder, inputs: NamedValues, conditions: NamedValues) -> NamedValues:
        ...
...
class MatrixElement(FunctionGenerator):
    class MatrixElementInput:
        ...
        Members:
          ...
          diagram_in
        """
        __members__: typing.ClassVar[dict[str, MatrixElement.MatrixElementInput]]  # value = {'momenta_in': <MatrixElementInput.momenta_in: 0>, 'alpha_s_in': <MatrixElementInput.alpha_s_in: 1>, 'flavor_in': <MatrixElementInput.flavor_in: 2>, 'random_color_in': <MatrixElementInput.random_color_in: 3>, 'random_helicity_in': <MatrixElementInput.random_helicity_in: 4>, 'random_diagram_in': <MatrixElementInput.random_diagram_in: 5>, 'helicity_in': <MatrixElementInput.helicity_in: 6>, 'diagram_in': <MatrixElementInput.diagram_in: 7>}
        alpha_s_in: typing.ClassVar[MatrixElement.MatrixElementInput]  # value = <MatrixElementInput.alpha_s_in: 1>
        diagram_in: typing.ClassVar[MatrixElement.MatrixElementInput]  # value = <MatrixElementInput.diagram_in: 7>
        flavor_in: typing.ClassVar[MatrixElement.MatrixElementInput]  # value = <MatrixElementInput.flavor_in: 2>
        helicity_in: typing.ClassVar[MatrixElement.MatrixElementInput]  # value = <MatrixElementInput.helicity_in: 6>
        momenta_in: typing.ClassVar[MatrixElement.MatrixElementInput]  # value = <MatrixElementInput.momenta_in: 0>
        random_color_in: typing.ClassVar[MatrixElement.MatrixElementInput]  # value = <MatrixElementInput.random_color_in: 3>
        random_diagram_in: typing.ClassVar[MatrixElement.MatrixElementInput]  # value = <MatrixElementInput.random_diagram_in: 5>
        random_helicity_in: typing.ClassVar[MatrixElement.MatrixElementInput]  # value = <MatrixElementInput.random_helicity_in: 4>
        def __eq__(self, other: typing.Any) -> bool:
            ...
        def __getstate__(self) -> int:
            ...
    ...
    class MatrixElementOutput:
        ...
        Members:
          ...
          diagram_index_out
        """
        __members__: typing.ClassVar[dict[str, MatrixElement.MatrixElementOutput]]  # value = {'matrix_element_out': <MatrixElementOutput.matrix_element_out: 0>, 'diagram_amp2_out': <MatrixElementOutput.diagram_amp2_out: 1>, 'color_index_out': <MatrixElementOutput.color_index_out: 2>, 'helicity_index_out': <MatrixElementOutput.helicity_index_out: 3>, 'diagram_index_out': <MatrixElementOutput.diagram_index_out: 4>}
        color_index_out: typing.ClassVar[MatrixElement.MatrixElementOutput]  # value = <MatrixElementOutput.color_index_out: 2>
        diagram_amp2_out: typing.ClassVar[MatrixElement.MatrixElementOutput]  # value = <MatrixElementOutput.diagram_amp2_out: 1>
        diagram_index_out: typing.ClassVar[MatrixElement.MatrixElementOutput]  # value = <MatrixElementOutput.diagram_index_out: 4>
        helicity_index_out: typing.ClassVar[MatrixElement.MatrixElementOutput]  # value = <MatrixElementOutput.helicity_index_out: 3>
        matrix_element_out: typing.ClassVar[MatrixElement.MatrixElementOutput]  # value = <MatrixElementOutput.matrix_element_out: 0>
        def __eq__(self, other: typing.Any) -> bool:
            ...
        def __getstate__(self) -> int:
            ...
    ...
    random_helicity_in: typing.ClassVar[MatrixElement.MatrixElementInput]  # value = <MatrixElementInput.random_helicity_in: 4>
    @typing.overload
    def __init__(self, matrix_element_index: typing.SupportsInt, particle_count: typing.SupportsInt, inputs: collections.abc.Sequence[MatrixElement.MatrixElementInput], outputs: collections.abc.Sequence[MatrixElement.MatrixElementOutput], diagram_count: typing.SupportsInt = 1, sample_random_inputs: bool = False) -> None:
        ...
    @typing.overload
    def __init__(self, matrix_element_api: MatrixElementApi, inputs: collections.abc.Sequence[MatrixElement.MatrixElementInput], outputs: collections.abc.Sequence[MatrixElement.MatrixElementOutput], sample_random_inputs: bool = False) -> None:
        ...
...
class MultiChannelIntegrand(FunctionGenerator):
    def __init__(self, integrands: collections.abc.Sequence[Integrand], return_sizes: bool = False) -> None:
        ...
...
class MultiMadnisTraining:
    def __init__(self, generator_context: Context, optimizer_context: Context, config: MadnisConfig, integrands: collections.abc.Sequence[collections.abc.Sequence[Integrand]], cwnets: collections.abc.Sequence[madspace._madspace_py.ChannelWeightNetwork | None]) -> None:
        ...
...
class NamedTypes:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, keys: collections.abc.Sequence[str], values: collections.abc.Sequence[Type]) -> None:
        ...
    @typing.overload
...
class NamedValues:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, keys: collections.abc.Sequence[str], values: collections.abc.Sequence[Value]) -> None:
        ...
    @typing.overload
...
class Observable(FunctionGenerator):
    class ObservableOption:
        ...
        Members:
          ...
          obs_sqrt_s
        """
        __members__: typing.ClassVar[dict[str, Observable.ObservableOption]]  # value = {'obs_e': <ObservableOption.obs_e: 0>, 'obs_px': <ObservableOption.obs_px: 1>, 'obs_py': <ObservableOption.obs_py: 2>, 'obs_pz': <ObservableOption.obs_pz: 3>, 'obs_mass': <ObservableOption.obs_mass: 4>, 'obs_pt': <ObservableOption.obs_pt: 5>, 'obs_p_mag': <ObservableOption.obs_p_mag: 6>, 'obs_phi': <ObservableOption.obs_phi: 7>, 'obs_theta': <ObservableOption.obs_theta: 8>, 'obs_y': <ObservableOption.obs_y: 9>, 'obs_y_abs': <ObservableOption.obs_y_abs: 10>, 'obs_eta': <ObservableOption.obs_eta: 11>, 'obs_eta_abs': <ObservableOption.obs_eta_abs: 12>, 'obs_delta_eta': <ObservableOption.obs_delta_eta: 13>, 'obs_delta_phi': <ObservableOption.obs_delta_phi: 14>, 'obs_delta_r': <ObservableOption.obs_delta_r: 15>, 'obs_sqrt_s': <ObservableOption.obs_sqrt_s: 16>}
        obs_delta_eta: typing.ClassVar[Observable.ObservableOption]  # value = <ObservableOption.obs_delta_eta: 13>
        obs_delta_phi: typing.ClassVar[Observable.ObservableOption]  # value = <ObservableOption.obs_delta_phi: 14>
        obs_delta_r: typing.ClassVar[Observable.ObservableOption]  # value = <ObservableOption.obs_delta_r: 15>
        obs_e: typing.ClassVar[Observable.ObservableOption]  # value = <ObservableOption.obs_e: 0>
        obs_eta: typing.ClassVar[Observable.ObservableOption]  # value = <ObservableOption.obs_eta: 11>
        obs_eta_abs: typing.ClassVar[Observable.ObservableOption]  # value = <ObservableOption.obs_eta_abs: 12>
        obs_mass: typing.ClassVar[Observable.ObservableOption]  # value = <ObservableOption.obs_mass: 4>
        obs_p_mag: typing.ClassVar[Observable.ObservableOption]  # value = <ObservableOption.obs_p_mag: 6>
        obs_phi: typing.ClassVar[Observable.ObservableOption]  # value = <ObservableOption.obs_phi: 7>
        obs_pt: typing.ClassVar[Observable.ObservableOption]  # value = <ObservableOption.obs_pt: 5>
        obs_px: typing.ClassVar[Observable.ObservableOption]  # value = <ObservableOption.obs_px: 1>
        obs_py: typing.ClassVar[Observable.ObservableOption]  # value = <ObservableOption.obs_py: 2>
        obs_pz: typing.ClassVar[Observable.ObservableOption]  # value = <ObservableOption.obs_pz: 3>
        obs_sqrt_s: typing.ClassVar[Observable.ObservableOption]  # value = <ObservableOption.obs_sqrt_s: 16>
        obs_theta: typing.ClassVar[Observable.ObservableOption]  # value = <ObservableOption.obs_theta: 8>
        obs_y: typing.ClassVar[Observable.ObservableOption]  # value = <ObservableOption.obs_y: 9>
        obs_y_abs: typing.ClassVar[Observable.ObservableOption]  # value = <ObservableOption.obs_y_abs: 10>
        def __eq__(self, other: typing.Any) -> bool:
            ...
        def __getstate__(self) -> int:
            ...
...
class PhaseSpaceMapping(Mapping):
    ...
    def __init__(self, topology: Topology, cm_energy: typing.SupportsFloat, leptonic: bool = False, invariant_power: typing.SupportsFloat = 0.8, t_channel_mode: PhaseSpaceMapping.TChannelMode = PhaseSpaceMapping.TChannelMode.TChannelMode.propagator, cuts: madspace._madspace_py.Cuts | None = None, permutations: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsInt]] = []) -> None:
        ...
    @typing.overload
    def __init__(self, masses: collections.abc.Sequence[typing.SupportsFloat], cm_energy: typing.SupportsFloat, leptonic: bool = False, invariant_power: typing.SupportsFloat = 0.8, mode: PhaseSpaceMapping.TChannelMode = PhaseSpaceMapping.TChannelMode.TChannelMode.rambo, cuts: madspace._madspace_py.Cuts | None = None) -> None:
        ...
    ...
    def random_dim(self) -> int:
        ...
class PrettyBox:
    def __init__(self, title: str, rows: typing.SupportsInt, columns: collections.abc.Sequence[typing.SupportsInt], offset: typing.SupportsInt = 0, box_width: typing.SupportsInt = 91) -> None:
        ...
    def print_first(self) -> None:
        ...
    def print_update(self) -> None:
        ...
    def set_cell(self, row: typing.SupportsInt, column: typing.SupportsInt, value: str) -> None:
        ...
    def set_column(self, column: typing.SupportsInt, values: collections.abc.Sequence[str]) -> None:
        ...
    def set_row(self, row: typing.SupportsInt, values: collections.abc.Sequence[str]) -> None:
        ...
    @property
    def line_count(self) -> int:
        ...
class Propagator:
    def __init__(self, mass: typing.SupportsFloat = 0.0, width: typing.SupportsFloat = 0.0, integration_order: typing.SupportsInt = 0, e_min: typing.SupportsFloat = 0.0, e_max: typing.SupportsFloat = 0.0, pdg_id: typing.SupportsInt = 0) -> None:
        ...
    @property
    def e_max(self) -> float:
        ...
...
class SubchannelWeights(FunctionGenerator):
    def __init__(self, topologies: collections.abc.Sequence[collections.abc.Sequence[Topology]], permutations: collections.abc.Sequence[collections.abc.Sequence[collections.abc.Sequence[typing.SupportsInt]]], channel_indices: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsInt]]) -> None:
        ...
    def channel_count(self) -> int:
        ...
class SubprocArgs:
    def __init__(self, process_id: typing.SupportsInt = 0, topologies: collections.abc.Sequence[Topology] = [], permutations: collections.abc.Sequence[collections.abc.Sequence[collections.abc.Sequence[typing.SupportsInt]]] = [], diagram_indices: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsInt]] = [], diagram_color_indices: collections.abc.Sequence[collections.abc.Sequence[collections.abc.Sequence[typing.SupportsInt]]] = [], color_flows: collections.abc.Sequence[collections.abc.Sequence[collections.abc.Sequence[tuple[typing.SupportsInt, typing.SupportsInt]]]] = [], pdg_color_types: collections.abc.Mapping[typing.SupportsInt, typing.SupportsInt] = {}, helicities: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsFloat]] = [], pdg_ids: collections.abc.Sequence[collections.abc.Sequence[collections.abc.Sequence[typing.SupportsInt]]] = [], matrix_flavor_indices: collections.abc.Sequence[typing.SupportsInt] = []) -> None:
        ...
    @property
    def color_flows(self) -> list[list[list[tuple[int, int]]]]:
        ...
    @color_flows.setter
    def color_flows(self, arg0: collections.abc.Sequence[collections.abc.Sequence[collections.abc.Sequence[tuple[typing.SupportsInt, typing.SupportsInt]]]]) -> None:
        ...
    @property
    def diagram_color_indices(self) -> list[list[list[int]]]:
        ...
    @diagram_color_indices.setter
    def diagram_color_indices(self, arg0: collections.abc.Sequence[collections.abc.Sequence[collections.abc.Sequence[typing.SupportsInt]]]) -> None:
        ...
    @property
    def diagram_indices(self) -> list[list[int]]:
        ...
    @diagram_indices.setter
    def diagram_indices(self, arg0: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsInt]]) -> None:
        ...
    @property
    def helicities(self) -> list[list[float]]:
        ...
    @helicities.setter
    def helicities(self, arg0: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsFloat]]) -> None:
        ...
    @property
    def matrix_flavor_indices(self) -> list[int]:
        ...
    @matrix_flavor_indices.setter
    def matrix_flavor_indices(self, arg0: collections.abc.Sequence[typing.SupportsInt]) -> None:
        ...
    @property
    def pdg_color_types(self) -> dict[int, int]:
        ...
    @pdg_color_types.setter
    def pdg_color_types(self, arg0: collections.abc.Mapping[typing.SupportsInt, typing.SupportsInt]) -> None:
        ...
    @property
    def pdg_ids(self) -> list[list[list[int]]]:
        ...
    @pdg_ids.setter
    def pdg_ids(self, arg0: collections.abc.Sequence[collections.abc.Sequence[collections.abc.Sequence[typing.SupportsInt]]]) -> None:
        ...
    @property
    def permutations(self) -> list[list[list[int]]]:
        ...
    @permutations.setter
    def permutations(self, arg0: collections.abc.Sequence[collections.abc.Sequence[collections.abc.Sequence[typing.SupportsInt]]]) -> None:
        ...
    @property
    def process_id(self) -> int:
        ...
...
class Topology:
    ...
    def __init__(self, diagram: Diagram) -> None:
        ...
    def propagator_momentum_terms(self, arg0: bool) -> list[tuple[list[int], float, float]]:
        ...
    @property
...
class TwoToThreeParticleScattering(Mapping):
    def __init__(self, t_invariant_power: typing.SupportsFloat = 0.0, t_mass: typing.SupportsFloat = 0.0, t_width: typing.SupportsFloat = 0.0, s_invariant_power: typing.SupportsFloat = 0.0, s_mass: typing.SupportsFloat = 0.0, s_width: typing.SupportsFloat = 0.0) -> None:
        ...
...
class VegasGridOptimizer:
    def __init__(self, contexts: collections.abc.Sequence[Context], grid_name: str, damping: typing.SupportsFloat) -> None:
        ...
...
class VegasHistogram(FunctionGenerator):
    def __init__(self, dimension: typing.SupportsInt, bin_count: typing.SupportsInt) -> None:
        ...
...
class Verbosity:
    ...
    Members:
      ...
      pretty
    """
    __members__: typing.ClassVar[dict[str, Verbosity]]  # value = {'silent': <Verbosity.silent: 0>, 'log': <Verbosity.log: 1>, 'pretty': <Verbosity.pretty: 2>}
