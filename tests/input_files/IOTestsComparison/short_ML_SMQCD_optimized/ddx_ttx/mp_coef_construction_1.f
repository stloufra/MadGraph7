...
C     Coefficient construction for loop diagram with ID 2
      ...
      CALL MP_ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,2),2,4,1,2,1,30,H)
C     Coefficient construction for loop diagram with ID 3
      ...
      CALL MP_ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,5),2,4,2,1,1,31,H)
...
C     Coefficient construction for loop diagram with ID 5
     ...
     $ )
      CALL MP_ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,11),2,4,4,1,1,33,H)
C     Coefficient construction for loop diagram with ID 6
     ...
     $ )
      CALL MP_ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,14),2,4,4,1,1,34,H)
C     Coefficient construction for loop diagram with ID 7
      CALL MP_FFV1L3_2(PL(0,13),W(4),GC_5,MDL_MT,MDL_WT,PL(0,15)
     $ ,COEFS)
     ...
     $ )
      CALL MP_ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,16),2,4,5,1,1,35,H)
C     Coefficient construction for loop diagram with ID 8
      CALL MP_FFV1L3_1(PL(0,13),W(3),GC_5,MDL_MT,MDL_WT,PL(0,17)
     $ ,COEFS)
     ...
     $ )
      CALL MP_ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,18),2,4,6,1,1,36,H)
C     Coefficient construction for loop diagram with ID 9
     ...
     $ )
      CALL MP_ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,20),2,1,1,1,1,37,H)
C     Coefficient construction for loop diagram with ID 10
     ...
     $ )
      CALL MP_ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,22),2,4,1,1,4,38,H)
C     Coefficient construction for loop diagram with ID 11
     ...
     $ )
      CALL MP_ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,24),2,4,7,1,1,39,H)
C     Coefficient construction for loop diagram with ID 12
      CALL MP_FFV1L2_1(PL(0,0),W(5),GC_5,MDL_MT,MDL_WT,PL(0,25)
     $ ,COEFS)
      CALL MP_ML5_0_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,25))
      CALL MP_FFV1L2_1(PL(0,25),W(6),GC_5,MDL_MT,MDL_WT,PL(0,26)
     $ ,COEFS)
      CALL MP_ML5_0_UPDATE_WL_1_1(WL(1,0,1,25),4,COEFS,4,4,WL(1,0,1,26)
     $ )
      CALL MP_ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,26),2,4,8,1,1,40,H)
