...
C     ----------
      ...
      CALL FFV1_1(W(1),W(2),GC_1,DCMPLX(ZERO),W(6))
      CALL FFV2P0_3(W(4),W(3),GC_124,DCMPLX(CMASS_MDL_MW),W(7))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(5),W(6),W(7),GC_124,AMP(1))
      CALL FFV2P0_3(W(5),W(1),GC_124,DCMPLX(CMASS_MDL_MW),W(6))
      CALL FFV1_2(W(4),W(2),GC_3,DCMPLX(ZERO),W(8))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(8),W(3),W(6),GC_124,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL VVV1_0(W(2),W(6),W(7),-GC_3,AMP(3))
      CALL FFV1_2(W(5),W(2),GC_2,DCMPLX(ZERO),W(6))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(6),W(1),W(7),GC_124,AMP(4))
