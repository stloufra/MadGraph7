...
C     ----------
      ...
      CALL FFV2P0_3(W(1),W(2),GC_124,DCMPLX(CMASS_MDL_MW),W(6))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1_2(W(1),W(5),GC_2,DCMPLX(ZERO),W(8))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(8),W(2),W(7),GC_124,AMP(3))
      CALL FFV1_1(W(2),W(5),GC_1,DCMPLX(ZERO),W(8))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1),W(8),W(7),GC_124,AMP(4))
