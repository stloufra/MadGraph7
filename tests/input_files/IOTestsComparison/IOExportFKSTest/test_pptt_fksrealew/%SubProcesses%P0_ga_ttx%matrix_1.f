...
C     ----------
      ...
      CALL FFV1_2(W(4),W(2),GC_2,MDL_MT,MDL_WT,W(7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(7),W(6),W(5),GC_11,AMP(1))
      CALL FFV1_2(W(4),W(5),GC_11,MDL_MT,MDL_WT,W(8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(8),W(6),W(2),GC_2,AMP(2))
      CALL FFV1_2(W(4),W(1),GC_11,MDL_MT,MDL_WT,W(6))
      CALL FFV1_1(W(3),W(2),GC_2,MDL_MT,MDL_WT,W(9))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(6),W(9),W(5),GC_11,AMP(3))
      CALL FFV1_1(W(3),W(5),GC_11,MDL_MT,MDL_WT,W(10))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(6),W(10),W(2),GC_2,AMP(4))
      CALL VVV1P0_1(W(1),W(5),GC_10,ZERO,ZERO,W(6))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(4),W(9),W(6),GC_11,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(7),W(3),W(6),GC_11,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(8),W(9),W(1),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(7),W(10),W(1),GC_11,AMP(8))
C     JAMPs contributing to orders QCD=2 QED=1
      TMP_JAMP(1) = AMP(5) +  AMP(6)  ! used 2 times
      JAMP(1,1) = (-1.000000000000000D+00)*AMP(1)+(-1.000000000000000D
     $ +00)*AMP(2)+(-1.000000000000000D+00)*AMP(7)
