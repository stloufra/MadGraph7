...
C         Handle the possible requirement of specific polarizations
     ...
     $     .EQ.0.AND.(.NOT.ML5_0_IS_HEL_SELECTED(H))) THEN
          ...
          CALL MP_FFV1P0_3(W(1,H),W(2,H),GC_5,ZERO,ZERO,W(5,H))
C         Amplitude(s) for born diagram with ID 1
          CALL MP_FFV1_0(W(4,H),W(3,H),W(5,H),GC_5,AMP(1,H))
          CALL MP_FFV1P0_3(W(4,H),W(3,H),GC_5,ZERO,ZERO,W(6,H))
C         Counter-term amplitude(s) for loop diagram number 2
          CALL MP_R2_GG_1_R2_GG_2_0(W(5,H),W(6,H),R2_GGG_1,R2_GGG_2
     $     ,AMPL(1,1))
...
C         Counter-term amplitude(s) for loop diagram number 5
          CALL MP_FFV1_0(W(1,H),W(2,H),W(6,H),R2_GQQ,AMPL(1,12))
          CALL MP_FFV1_0(W(1,H),W(2,H),W(6,H),UV_GQQB_1EPS,AMPL(2,13))
          CALL MP_FFV1_0(W(1,H),W(2,H),W(6,H),UV_GQQB_1EPS,AMPL(2,14))
          CALL MP_FFV1_0(W(1,H),W(2,H),W(6,H),UV_GQQB_1EPS,AMPL(2,15))
          CALL MP_FFV1_0(W(1,H),W(2,H),W(6,H),UV_GQQB_1EPS,AMPL(2,16))
          CALL MP_FFV1_0(W(1,H),W(2,H),W(6,H),UV_GQQB_1EPS,AMPL(2,17))
          CALL MP_FFV1_0(W(1,H),W(2,H),W(6,H),UV_GQQB_1EPS,AMPL(2,18))
          CALL MP_FFV1_0(W(1,H),W(2,H),W(6,H),UV_GQQG_1EPS,AMPL(2,19))
          CALL MP_FFV1_0(W(1,H),W(2,H),W(6,H),UV_GQQB,AMPL(1,20))
          CALL MP_FFV1_0(W(1,H),W(2,H),W(6,H),UV_GQQT,AMPL(1,21))
C         Counter-term amplitude(s) for loop diagram number 10
          CALL MP_R2_GG_1_0(W(5,H),W(6,H),R2_GGQ,AMPL(1,22))
          CALL MP_R2_GG_1_0(W(5,H),W(6,H),R2_GGQ,AMPL(1,23))
          CALL MP_R2_GG_1_0(W(5,H),W(6,H),R2_GGQ,AMPL(1,24))
          CALL MP_R2_GG_1_0(W(5,H),W(6,H),R2_GGQ,AMPL(1,25))
C         Counter-term amplitude(s) for loop diagram number 11
          CALL MP_R2_GG_1_R2_GG_3_0(W(5,H),W(6,H),R2_GGQ,R2_GGB,AMPL(1
     $     ,26))
C         Counter-term amplitude(s) for loop diagram number 12
          CALL MP_R2_GG_1_R2_GG_3_0(W(5,H),W(6,H),R2_GGQ,R2_GGT,AMPL(1
     $     ,27))
C         Amplitude(s) for UVCT diagram with ID 13
          CALL MP_FFV1_0(W(4,H),W(3,H),W(5,H),GC_5,AMPL(2,28))
          AMPL(2,28)=AMPL(2,28)*(2.0D0*UVWFCT_B_0_1EPS)
C         Amplitude(s) for UVCT diagram with ID 14
          CALL MP_FFV1_0(W(4,H),W(3,H),W(5,H),GC_5,AMPL(1,29))
