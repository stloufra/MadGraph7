...
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(5),W(3),W(4),-GC_70,AMP2(1))
      CALL FFS3_3(W(1),W(2),GC_30,MDL_MW,MDL_WW,W(5))
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(3),W(4),W(5),GC_84,AMP2(2))
      CALL FFV2_2(W(1),W(3),GC_124,ZERO,ZERO,W(5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_3_0(W(5),W(2),W(4),GC_68,GC_76,AMP2(3))
      CALL FFV2_5_2(W(1),W(4),-GC_68,GC_76,MDL_MT,MDL_WT,W(5))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(5),W(2),W(3),GC_124,AMP2(4))
C     JAMPs contributing to orders QCD=0 QED=2
