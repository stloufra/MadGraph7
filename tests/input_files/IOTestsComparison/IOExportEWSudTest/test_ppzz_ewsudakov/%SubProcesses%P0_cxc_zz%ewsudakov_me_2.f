...
C     Helas calls and color basis for the Sudakov amplitude
      ...
      CALL IXXXXX(P(0,2),ZERO,NHEL(2),+1*IC(2),W(2))
      CALL VXXXXX(P(0,3),MDL_MZ,NHEL(3),+1*IC(3),W(3))
      CALL VXXXXX(P(0,4),ZERO,NHEL(4),+1*IC(4),W(4))
      CALL FFV2_5_1(W(1),W(3),-GC_68,GC_76,ZERO,ZERO,W(5))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(2),W(5),W(4),GC_2,AMP2(1))
      CALL FFV1_1(W(1),W(4),GC_2,ZERO,ZERO,W(5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_5_0(W(2),W(5),W(3),-GC_68,GC_76,AMP2(2))
C     JAMPs contributing to orders QCD=0 QED=2
