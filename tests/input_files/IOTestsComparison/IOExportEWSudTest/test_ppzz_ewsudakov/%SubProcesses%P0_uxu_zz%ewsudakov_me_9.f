...
C     Helas calls and color basis for the base amplitude
      ...
      CALL FFV2_5_1(W(1),W(3),-GC_68,GC_76,ZERO,ZERO,W(5))
C     Amplitude(s) for diagram number 1
      CALL FFV2_5_0(W(2),W(5),W(4),-GC_68,GC_76,AMP1(1))
      CALL FFV2_5_1(W(1),W(4),-GC_68,GC_76,ZERO,ZERO,W(5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_5_0(W(2),W(5),W(3),-GC_68,GC_76,AMP1(2))
...
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(5),W(3),W(4),-GC_3,AMP2(1))
      CALL FFV2_5P0_3(W(2),W(1),-GC_68,GC_76,MDL_MZ,MDL_WZ,W(5))
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(3),W(4),W(5),-GC_70,AMP2(2))
