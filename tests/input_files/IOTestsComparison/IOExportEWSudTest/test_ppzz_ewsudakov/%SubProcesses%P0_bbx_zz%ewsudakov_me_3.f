...
C     Helas calls and color basis for the Sudakov amplitude
      CALL IXXXXX(P(0,1),MDL_MT,NHEL(1),+1*IC(1),W(1))
      CALL OXXXXX(P(0,2),MDL_MT,NHEL(2),-1*IC(2),W(2))
      CALL VXXXXX(P(0,3),MDL_MZ,NHEL(3),+1*IC(3),W(3))
      CALL VXXXXX(P(0,4),MDL_MZ,NHEL(4),+1*IC(4),W(4))
      CALL FFS4_3(W(1),W(2),GC_116,MDL_MH,MDL_WH,W(5))
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(3),W(4),W(5),GC_99,AMP2(1))
      CALL FFV2_5_2(W(1),W(3),-GC_68,GC_76,MDL_MT,MDL_WT,W(5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_5_0(W(5),W(2),W(4),-GC_68,GC_76,AMP2(2))
      CALL FFV2_5_2(W(1),W(4),-GC_68,GC_76,MDL_MT,MDL_WT,W(5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(5),W(2),W(3),-GC_68,GC_76,AMP2(3))
C     JAMPs contributing to orders QCD=0 QED=2
