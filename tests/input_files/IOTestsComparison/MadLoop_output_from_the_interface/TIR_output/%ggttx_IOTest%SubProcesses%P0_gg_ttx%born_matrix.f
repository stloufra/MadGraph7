      SUBROUTINE ML5_0_SMATRIX(P, FLAV_IDX, ANS_SUMMED)
C     
...
C     BEGIN CODE
C     
      CALL ML5_0_SMATRIX_SPLITORDERS(P, FLAV_IDX, ANS)
      ANS_SUMMED=ANS(0)
...
C     ----------
      ...
      SUBROUTINE ML5_0_SMATRIXHEL_SPLITORDERS(P,HEL, FLAV_IDX, ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     ----------
      ...
      SUBROUTINE ML5_0_SMATRIX_SPLITORDERS(P, FLAV_IDX, ANS)
C     
...
C      only three external particles.
     ...
     $       -1.AND.(.NOT.ML5_0_IS_BORN_HEL_SELECTED(IHEL))) THEN
              CYCLE
            ENDIF
            CALL ML5_0_MATRIX(P ,NHEL(1,IHEL),JC(1),FLAV_IDX, T)
            BUFF=0D0
            DO I=1,NSQAMPSO
     ...
     $        THEN
      ...
      SUBROUTINE ML5_0_MATRIX(P,NHEL,IC,FLAV_IDX,RES)
      USE MODEL_OBJECT
C     
C     Generated by MadGraph5_aMC@NLO v. %(version)s, %(date)s
C     By the MadGraph5_aMC@NLO Development Team
...
CF2PY INTENT(IN) :: FLAVOR(NEXTERNAL)
      ...
      FLAV_IDX = ML5_0_GET_FLAVOR_INDEX(FLAVOR)
      CALL ML5_0_GET_VALUE_IDX(P, ALPHAS, NHEL, FLAV_IDX, ANS)
      RETURN
      END
