...
C     Coefficient construction for loop diagram with ID 26
      CALL VVVV1L2P0_1(PL(0,0),W(2),W(1),GC_6,ZERO,ZERO,PL(0,57)
     $ ,COEFS)
      CALL ML5_0_UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,57))
      CALL VVVV3L2P0_1(PL(0,0),W(2),W(1),GC_6,ZERO,ZERO,PL(0,58)
     $ ,COEFS)
      CALL ML5_0_UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,58))
      CALL VVVV4L2P0_1(PL(0,0),W(2),W(1),GC_6,ZERO,ZERO,PL(0,59)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 27
      CALL VVVV1L2P0_1(PL(0,4),W(2),W(1),GC_6,ZERO,ZERO,PL(0,63)
     $ ,COEFS)
      CALL ML5_0_UPDATE_WL_1_0(WL(1,0,1,4),4,COEFS,4,4,WL(1,0,1,63))
      CALL VVVV3L2P0_1(PL(0,4),W(2),W(1),GC_6,ZERO,ZERO,PL(0,64)
     $ ,COEFS)
      CALL ML5_0_UPDATE_WL_1_0(WL(1,0,1,4),4,COEFS,4,4,WL(1,0,1,64))
      CALL VVVV4L2P0_1(PL(0,4),W(2),W(1),GC_6,ZERO,ZERO,PL(0,65)
     $ ,COEFS)
