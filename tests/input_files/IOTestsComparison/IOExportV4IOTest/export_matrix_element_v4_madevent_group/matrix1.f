      SUBROUTINE SMATRIX1(P, IFLAV, RHEL, RCOL, CHANNEL, IVEC, ANS,
     $  IHEL, ICOL)
C     
...
C      where in initialization mode as well for the helicity.
     ...
     $      THEN
            T=MATRIX1(P ,NHEL(1,I),FLAVOR(1,IFLAV),I,AMP2, JAMP2, IVEC)
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
        ...
        ENDIF
      ENDIF
      ANS=ANS/DBLE(IDEN)*BROKEN_SYM1(FLAVOR(1,IFLAV))
      ...
      REAL*8 FUNCTION MATRIX1(P,NHEL,FLAVOR, IHEL,AMP2, JAMP2, IVEC)
C     
C     Generated by MadGraph5_aMC@NLO v. %(version)s, %(date)s
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(4),W(3),W(5),GQQ,AMP(1))
      CALL FFV1_3(W(1),W(2),GQED,ZERO, FK_ZERO,W(5))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(4),W(3),W(5),GQED,AMP(2))
      CALL FFV1_2_3(W(1),W(2),GUZ1,GUZ2,MZ, FK_WZ,W(5))
C     Amplitude(s) for diagram number 3
      CALL FFV1_2_0(W(4),W(3),W(5),GUZ1,GUZ2,AMP(3))
      CALL FFV1_3(W(1),W(3),GQQ,ZERO, FK_ZERO,W(5))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(4),W(2),W(5),GQQ,AMP(4))
      CALL FFV1_3(W(1),W(3),GQED,ZERO, FK_ZERO,W(5))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(4),W(2),W(5),GQED,AMP(5))
      CALL FFV1_2_3(W(1),W(3),GUZ1,GUZ2,MZ, ZERO,W(5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_2_0(W(4),W(2),W(5),GUZ1,GUZ2,AMP(6))
...
C     get old symmetry factor
      OLD_FACTOR = 1
      DO I=NINCOMING+1, NEXTERNAL
        IF (PID(I).EQ.0) CYCLE
        N_TOT=1
        DO J = I+1,NEXTERNAL
          IF (PID(I).EQ.PID(J))THEN
            PID(J) = 0
            N_TOT = N_TOT+1
