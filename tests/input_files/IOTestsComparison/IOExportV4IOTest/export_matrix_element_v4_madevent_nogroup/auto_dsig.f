...
C         Select a flavor combination (need to do here for right sign)
     ...
     $  CHANNELS, ALL_OUT , SELECTED_HEL, SELECTED_COL, VECSIZE_USED)
...
C           Call UNWGT to unweight and store events
     ...
     $  CHANNELS, OUT, SELECTED_HEL, SELECTED_COL, VECSIZE_USED)
      USE OMP_LIB
      IMPLICIT NONE
