...
// Created originally by: J. Teig (Jun 2023, based on earlier work by S.
// Roiser) for the MG5aMC CUDACPP plugin.
// Further modified by: O. Mattelaer, S. Roiser, J. Teig, A. Valassi, Z.
// Wettersten (2020-2025).
