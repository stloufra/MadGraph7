...
//==========================================================================
// Classic (massive) RAMBO phase-space generator for the standalone_mg7 driver.
...
//   - wrapped in namespace classic_rambo and made header-only (inline);
...
#ifndef CLASSIC_RAMBO_H
#define CLASSIC_RAMBO_H 1
